...
# Cluster 20 are antibody aggregates, these are excluded in several analyses
...
write_csv(x = intensity_fold_changes,
          file = file.path(model_dir,"HeLa_intensity_fold_changes_SBF2_raw_csl.csv"))
...
write_csv(x = size_fold_changes,
          file = file.path(model_dir,"HeLa_size_fold_changes_SBF2_raw_csl.csv"))
