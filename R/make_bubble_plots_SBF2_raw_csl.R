...
intensity_fold_changes_full <- read_csv(file = file.path(model_dir,"HeLa_intensity_fold_changes_SBF2_raw_csl.csv"))
size_fold_changes_full <- read_csv(file = file.path(model_dir,"HeLa_size_fold_changes_SBF2_raw_csl.csv"))
...
ggsave(plot = combined_plot,filename = file.path(plot_dir,paste0("unnormalised_dot_plot_",current_siRNA,"_raw_csl.pdf")),width=16,height=8,units="cm")
ggsave_cairo(plot = combined_plot,filename = file.path(plot_dir,paste0("unnormalised_dot_plot_",current_siRNA,"_raw_csl.png")),width=16,height=8,units="cm",dpi=600)

# make just the P-body plots
to_plot <- fold_changes_to_plot %>%
  filter(siRNA==current_siRNA) %>%
  filter(comparison=="unnormalised")
cols <- hclust_cols(to_plot)
...
bubble_plot <- make_bubble_plot(fold_changes = filter(to_plot,cluster %in% c(13,19)),
                                plot_var = log2_fold_change,
                                col_var = channel_name,
                                row_var = cluster,
                                col_order=cols,
...
size_bubble_plot <- make_bubble_plot(fold_changes = filter(sizes_to_plot,cluster %in% c(13,19)),
                                     plot_var = log2_fold_change,
                                     col_var = axis_label,
                                     row_var = cluster,
                                     row_order=rows,
...
combined_plot <- (
  ...
  plot_layout(widths=c(1,30)) & theme(legend.position = "none")
combined_plot

ggsave(plot = combined_plot,filename = file.path(plot_dir,paste0("unnormalised_dot_plot_",current_siRNA,"_raw_csl_p_body.pdf")),width=14,height=3.2,units="cm")
ggsave_cairo(plot = combined_plot,filename = file.path(plot_dir,paste0("unnormalised_dot_plot_",current_siRNA,"_raw_csl_p_body.png")),width=14,height=3.2,units="cm",dpi=600)
...
ggsave(plot = combined_plot,filename = file.path(plot_dir,paste0("normalised_dot_plot_",current_siRNA,"_raw_csl.pdf")),width=16,height=9,units="cm")
ggsave_cairo(plot = combined_plot,filename = file.path(plot_dir,paste0("normalised_dot_plot_",current_siRNA,"_raw_csl.png")),width=16,height=9,units="cm",dpi=600)

# make just the P-body plots
p_body_cytoplasm_bubble_plot <- make_bubble_plot(fold_changes = filter(to_plot_cytoplasm,cluster %in% c(13,19)),
                                          plot_var = log2_fold_change,
                                          col_var = channel_name,
                                          row_var = cluster,
                                          col_order=cols,
...
p_body_cytoplasm_size_bubble_plot <- make_bubble_plot(fold_changes = filter(sizes_to_plot_cytoplasm,cluster %in% c(13,19)),
                                               plot_var = log2_fold_change,
                                               col_var = axis_label,
                                               row_var = cluster,
                                               row_order=rows,
...
combined_plot <- ( p_body_cytoplasm_size_bubble_plot  +
      theme(axis.title.x = element_blank(),
            axis.title.y = element_blank(),
            legend.position = "none") ) + 
  ( p_body_cytoplasm_bubble_plot +
      xlab("Channel") + 
      theme(axis.text.y=element_blank(),
            axis.ticks.y=element_blank()) ) +
  plot_layout(widths=c(1,30),ncol = 2,nrow=1,guides="collect") & theme(legend.position = "none")
combined_plot
ggsave(plot = combined_plot,filename = file.path(plot_dir,paste0("normalised_dot_plot_",current_siRNA,"_raw_csl_p_body.pdf")),width=14,height=3.2,units="cm")
ggsave_cairo(plot = combined_plot,filename = file.path(plot_dir,paste0("normalised_dot_plot_",current_siRNA,"_raw_csl_p_body.png")),width=14,height=3.2,units="cm",dpi=600)
...
ggsave(plot = combined_plot,filename = file.path(plot_dir,paste0("normalised_dot_plot_sizes_only_",current_siRNA,"_raw_csl.pdf")),width=4.2,height=6.5,units="cm")
ggsave_cairo(plot = combined_plot,filename = file.path(plot_dir,paste0("normalised_dot_plot_sizes_only_",current_siRNA,"_raw_csl.png")),width=4.2,height=6.5,units="cm",dpi=600)

ggpubr::as_ggplot(
  ggpubr::get_legend(combined_plot & theme(legend.position = "right"))
)
ggsave(filename = file.path(plot_dir,paste0("normalised_dot_plot_sizes_only_",current_siRNA,"_legend_raw_csl.pdf")),width=4.2,height=3,units="cm")
ggsave_cairo(filename = file.path(plot_dir,paste0("normalised_dot_plot_sizes_only_",current_siRNA,"_legend_raw_csl.png")),width=4.2,height=3,units="cm",dpi=600)
